/*   STEP 1   */
export const leagueID = "1261098808725483520"; // your league ID
export const leagueName = "1993 White Ford Bronco"; // your league name
...
export const managers = [
    ...
    },
    {
      ...
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Miguel", // Can be anything (usually your rival's name)
    ...
    },
    {
      ...
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Andi", // Can be anything (usually your rival's name)
    ...
    },
    {
      ...
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Anna", // Can be anything (usually your rival's name)
